...
const DEFAULT_BEHIND_GRADIENT =
  "radial-gradient(farthest-side circle at var(--pointer-x) var(--pointer-y),hsla(24,100%,90%,var(--card-opacity)) 4%,hsla(24,70%,80%,calc(var(--card-opacity)*0.75)) 10%,hsla(24,50%,70%,calc(var(--card-opacity)*0.5)) 50%,hsla(24,0%,60%,0) 100%),radial-gradient(35% 52% at 55% 20%,#E0702E 0%,#073aff00 100%),radial-gradient(100% 100% at 50% 50%,#E0702E 1%,#073aff00 76%),conic-gradient(from 124deg at 50% 50%,#E0702E 0%,#C1561C 40%,#C1561C 60%,#E0702E 100%)";

const DEFAULT_INNER_GRADIENT =
  "linear-gradient(145deg, #1C0F0A 0%, #0D0D0D 100%)";
